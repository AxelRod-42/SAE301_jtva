...
<body>
    ...
    <main class="mainB">
        <section class="shop">
                ...
                <div class="supporter">
                    <p>Fervant supporter ?</p>
                    <img class="supporterIMG" src="../image/icone/directive.png" alt="Flèche directive" width="100" height="50">
                </div>
                ...
                <div class="maillots">Maillots du club</div>
